...
export const CardActivityLarge = () => {
  return (
    <div>
      <div className=''>
        <div className='overflow-hidden relative max-w-[848px] max-h-[548px] rounded-[30px]'>
          ...
          <div className='absolute bottom-0 left-0 p-2  h-[84px] bg-primary md:py-5 md:px-9 md:h-[200px]'>
            <div className='md:mb-2'>
              <p className='font-prompts font-medium text-white line-clamp-2 h3'>
                Computer Vision Syndrome (CVS) : โรคใกล้ตัวของคนทำงานยุคใหม่ เพราะจ้องหน้าจอมากเกินไป
              </p>
            </div>
            <div className='hidden mb-3 md:block'>
              <p className='font-sarabun text-sm font-normal text-white line-clamp-2 2xl:text-base'>
